...
(async () => {
  ...
  // Report page/console errors as warnings (don't fail the test — these are often
  // benign runtime errors like Performance API timestamps)
  if (pageErrors.length > 0) {
    console.log(`\n  WARNING: ${pageErrors.length} page error(s):`);
  ...
  // Final result — only structural check failures count
  if (errors.length === 0) {
