...
**Input:** "Alex submitted the TargetCo application, now waiting. No follow-up needed Thursday."
...
**Input:** "TargetCo demo shipped Jan 13. Update all references from 'working on demo' to 'demo shipped'."
...
Context added:
- Demo reception: positive feedback from Raj
