...
Chief has written a lightweight spec in `Desktop/working/{conversation-id}/spec.md`. It contains:
...
Then call:
```python
done(summary="Research plan created with {N} sources and {M} criteria")
```
