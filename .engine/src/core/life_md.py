...
class LifeMdService:
    ...
    def _extract_role_when(self, content: str, role_name: str) -> str:
        ...
        defaults = {
            ...
            'writer': 'Sustained focus on a single artifact',
            'researcher': 'Investigates topics and synthesizes findings',
            'curator': 'Audits, organizes, and maintains system accuracy',
